import {  CHANGE_ASSIGNESS, CHANGE_TASK_DETAIL_REDUCER, GET_TASK_DETAIL_MODAL_REDUCER, REMOVE_USER_ASSIGNESS } from "../constants/CyberBug/TaskConst"
...
export const TaskReducer=(state=stateDefault, action)=>{
    switch(action.type){
        case GET_TASK_DETAIL_MODAL_REDUCER:{
          console.log(123)
